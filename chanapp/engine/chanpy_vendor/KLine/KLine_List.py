...
from chanapp.engine.chanpy_vendor.Bi.Bi import CBi
from chanapp.engine.chanpy_vendor.Bi.BiList import CBiList
from chanapp.engine.chanpy_vendor.BuySellPoint.BSPointList import CBSPointList
from chanapp.engine.chanpy_vendor.ChanConfig import CChanConfig
from chanapp.engine.chanpy_vendor.Common.CEnum import KLINE_DIR, SEG_TYPE
from chanapp.engine.chanpy_vendor.Common.ChanException import CChanException, ErrCode
from chanapp.engine.chanpy_vendor.Seg.Seg import CSeg
from chanapp.engine.chanpy_vendor.Seg.SegConfig import CSegConfig
from chanapp.engine.chanpy_vendor.Seg.SegListComm import CSegListComm
from chanapp.engine.chanpy_vendor.ZS.ZSList import CZSList
...
def get_seglist_instance(seg_config: CSegConfig, lv) -> CSegListComm:
    if seg_config.seg_algo == "chan":
        from chanapp.engine.chanpy_vendor.Seg.SegListChan import CSegListChan
        ...
        from chanapp.engine.chanpy_vendor.Seg.SegListDYH import CSegListDYH
        return CSegListDYH(seg_config, lv)
    elif seg_config.seg_algo == "break":
        print(f'Please avoid using seg_algo={seg_config.seg_algo} as it is deprecated and no longer maintained.')
        from chanapp.engine.chanpy_vendor.Seg.SegListDef import CSegListDef
