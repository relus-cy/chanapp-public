...
from chanapp.engine.chanpy_vendor.Common.CEnum import DATA_FIELD, TRADE_INFO_LST, TREND_TYPE
from chanapp.engine.chanpy_vendor.Common.ChanException import CChanException, ErrCode
from chanapp.engine.chanpy_vendor.Common.CTime import CTime
from chanapp.engine.chanpy_vendor.Math.BOLL import BOLL_Metric, BollModel
from chanapp.engine.chanpy_vendor.Math.Demark import CDemarkEngine, CDemarkIndex
from chanapp.engine.chanpy_vendor.Math.KDJ import KDJ
from chanapp.engine.chanpy_vendor.Math.MACD import CMACD, CMACD_item
...
class CKLine_Unit:
    def __init__(self, kl_dict, autofix=False):
        ...
        from chanapp.engine.chanpy_vendor.KLine.KLine import CKLine
