...
from chanapp.engine.chanpy_vendor.Common.CEnum import BI_DIR, MACD_ALGO, TREND_LINE_SIDE
...
from chanapp.engine.chanpy_vendor.Math.TrendLine import CTrendLine
...
class CSeg(Generic[LINE_TYPE]):
    def __init__(self, idx: int, start_bi: LINE_TYPE, end_bi: LINE_TYPE, is_sure=True, seg_dir=None, reason="normal"):
        ...
        from chanapp.engine.chanpy_vendor.ZS.ZS import CZS
