...
from chanapp.engine.chanpy_vendor.Common.cache import make_cache
from chanapp.engine.chanpy_vendor.Common.CEnum import BI_DIR, BI_TYPE, DATA_FIELD, FX_TYPE, MACD_ALGO
...
from chanapp.engine.chanpy_vendor.KLine.KLine_Unit import CKLine_Unit
...
class CBi:
    def __init__(self, begin_klc: CKLine, end_klc: CKLine, idx: int, is_sure: bool):
        ...
        from chanapp.engine.chanpy_vendor.BuySellPoint.BS_Point import CBS_Point
